...
class ViT(LightningModule):
    def __init__(self, patch_size, image_shape, num_layers, num_heads, embed_dim, num_classes, num_channels):
        super().__init__()
        ...
        self.num_patches = math.ceil(image_shape[0] / patch_size) * math.ceil(image_shape[1] / patch_size)
    ...
    def init_tokenizer(self, patch_size, image_shape, num_channels):
        self.tokenizer = ViTTokenizer(embed_dim=self.embed_dim, image_shape=image_shape, patch_size=patch_size, num_channels=num_channels)
